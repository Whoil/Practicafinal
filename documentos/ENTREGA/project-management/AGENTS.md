...
- Leer `documentos/ENTREGA/project-management/PRD.md`, `ARCHITECTURE.md`, `TASKS.md` y `DECISIONS.md` antes de proponer cambios.
...
Los archivos de `documentos/ENTREGA/project-management/` son el mecanismo principal para coordinar agentes.
...
test/
documentos/ENTREGA/project-management/
