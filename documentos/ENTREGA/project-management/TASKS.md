...
- Estado: PENDIENTE
- Archivos permitidos: `documentos/diagramas uml/`, `documentos/ENTREGA/project-management/`
...
- Responsable: Coordinador
- Estado: PENDIENTE
- Archivos permitidos: `documentos/`, `documentos/ENTREGA/project-management/`
...
- Responsable: Por asignar
- Estado: PENDIENTE
- Archivos permitidos: `documentos/`, `documentos/diagramas uml/`
...
- Responsable: Por asignar
- Estado: PENDIENTE
- Archivos permitidos: `documentos/`
...
- Responsable: Coordinador
- Estado: PENDIENTE
- Archivos permitidos: `documentos/diagramas uml/casos-de-uso/`, `documentos/ENTREGA/project-management/`
...
- Responsable: Coordinador
- Estado: PENDIENTE
- Archivos permitidos: `documentos/diagramas uml/secuencia/`, `documentos/ENTREGA/project-management/`
...
- Responsable: Coordinador
- Estado: PENDIENTE
- Archivos permitidos: `documentos/diagramas uml/estados/`, `documentos/ENTREGA/project-management/`
...
- Responsable: Coordinador
- Estado: PENDIENTE
- Archivos permitidos: `documentos/diagramas uml/actividad/`, `documentos/ENTREGA/project-management/`
...
- Estado: PENDIENTE
- Archivos permitidos: `src/Estructuras/`, `src/ParteA/`, `src/ParteB/Grafo/`, `documentos/ENTREGA/project-management/`
...
- Estado: HECHA
- Archivos permitidos: `src/modelo/objetos/`, `src/modelo/personajes/`, `src/Estructuras/ListaDE.java`, `src/Estructuras/ElementoDE.java`, `src/Estructuras/IteradorDE.java`, `test/`, `documentos/ENTREGA/project-management/`
...
- Estado: HECHA
- Archivos permitidos: `src/json/`, `test/`, `documentos/ENTREGA/project-management/`
...
- Responsable: Guille / Parte B
- Estado: HECHA
- Archivos permitidos: `src/modelo/juego/`, `src/modelo/personajes/`, `src/modelo/objetos/`, `test/`, `documentos/ENTREGA/project-management/`
...
- Responsable: Guille / Parte B
- Estado: PENDIENTE
- Archivos permitidos: `src/modelo/juego/`, `src/modelo/personajes/`, `src/modelo/objetos/`, `src/modelo/mapa/`, `test/`, `documentos/ENTREGA/project-management/`
...
- Verificacion: documento `documentos/BOCETO_JAVAFX.md` (234 lineas) con layout ASCII, 5 zonas detalladas, tabla de colores, mapeo JavaFX, flujo de datos, estructura de clases para C-04, contrato minimo de Partida, estrategia mock y checklist.

### C-04 Menu principal JavaFX

- Responsable: Hector / Parte C
- Estado: HECHA
- Archivos permitidos: `src/vista/`, `src/controlador/`, `documentos/ENTREGA/project-management/`
...
- Responsable: Hector / Parte C
- Estado: HECHA
- Archivos permitidos: `src/modelo/juego/Partida.java`, `src/vista/PantallaJuego.java`, `src/vista/EscapeMazmorraApp.java`, `test/`, `documentos/ENTREGA/project-management/`
...
- Responsable: Hector / Parte C
- Estado: PENDIENTE
- Archivos permitidos: `src/modelo/juego/`, `src/modelo/personajes/`, `src/vista/`, `test/`, `documentos/ENTREGA/project-management/`
- Terminado cuando:
...
- Responsable: Hector / Parte C
- Estado: EN_CURSO
- Archivos permitidos: `src/vista/`, `datos/`, recursos graficos/audio, `documentos/ENTREGA/project-management/`
...
- Estado: HECHA
- Archivos permitidos: `src/modelo/mapa/`, `test/`, `documentos/ENTREGA/project-management/`
...
- Responsable: Alvaro + Codex-A Estructuras
- Estado: HECHA
- Archivos permitidos: `src/modelo/juego/`, `src/modelo/mapa/`, `test/`, `documentos/ENTREGA/project-management/`
...
- Responsable: Guille / Parte B
- Estado: HECHA
- Archivos permitidos: `src/modelo/personajes/`, `test/`, `documentos/ENTREGA/project-management/`
...
- Estado: HECHA
- Archivos permitidos: `src/Estructuras/`, `documentos/ENTREGA/project-management/`
...
- Estado: HECHA
- Archivos permitidos: `src/modelo/juego/`, `src/vista/`, `test/`, `documentos/ENTREGA/project-management/`
...
- Responsable: Hector / Parte C
- Estado: HECHA
- Archivos permitidos: `src/json/`, `datos/`, `documentos/ENTREGA/project-management/`
...
- Estado: HECHA
- Archivos permitidos: `test/`, `datos/cuevas.json`, `documentos/ENTREGA/project-management/`
...
- Estado: HECHA
- Archivos permitidos: `src/modelo/juego/`, `test/modelo/juego/`, `datos/cuevas.json`, `documentos/ENTREGA/project-management/DECISIONS.md`
...
- Responsable: Hector / Parte C
- Estado: HECHA
- Archivos permitidos: `src/vista/`, `src/json/`, `src/modelo/juego/`, `documentos/ENTREGA/project-management/`
...
- Estado: HECHA
- Archivos permitidos: `src/json/`, `src/modelo/juego/`, `src/vista/`, `test/`, `documentos/ENTREGA/project-management/`
...
- Responsable: Hector / Parte C
- Estado: HECHA
- Archivos permitidos: `src/vista/`, `documentos/ENTREGA/project-management/`
...
- Estado: HECHA
- Archivos permitidos: `src/modelo/juego/`, `src/json/`, `src/vista/`, `test/`, `documentos/ENTREGA/project-management/`
...
- Estado: HECHA
- Archivos permitidos: `src/vista/EscapeMazmorraApp.java`, `documentos/ENTREGA/project-management/`
...
- Responsable: Coordinador
- Estado: HECHA
- Archivos permitidos: `documentos/ENTREGA/project-management/`
